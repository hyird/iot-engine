...
export const getRuleDetail = (id: string) =>
    createSnapshotStream<Alert.RuleItem>(`${BASE}/rules/${id}`);
...
export const getTemplateDetail = (id: string) =>
    createSnapshotStream<Alert.TemplateDetail>(`${BASE}/templates/${id}`);
...
export const getStats = () => createSnapshotStream<Alert.ActiveStats>(`${BASE}/stats`);
