...
export const getDevices = () =>
    createSnapshotStream<GB28181.Items<GB28181.Device>>(`${BASE}/devices`);
export const getStreams = () =>
    createSnapshotStream<GB28181.Items<GB28181.StreamStatus>>(`${BASE}/streams`);
...
export const getRecording = (payload: GB28181.StreamPayload) =>
    createSnapshotStream<GB28181.CommandResult>(
