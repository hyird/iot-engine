...
const permissionOptions = [
    ...
    ['iot:alert:query', '查询告警'],
    ['iot:alert:add', '新增告警规则'],
    ['iot:alert:edit', '编辑告警规则'],
    ['iot:alert:delete', '删除告警规则'],
    ['iot:alert:ack', '确认告警'],
    ['iot:gb28181:query', '查询 GB28181 设备与视频'],
    ['iot:gb28181:control', '控制 GB28181 预览与云台'],
    ['iot:gb28181:record', '查询与回放 GB28181 录像'],
