...
int main() {
    try {
        ...
        require(preparation.find("text(routeQuery.column(service::command::persistence::DeviceModelEntity::columnName<\"config\">(), \"p\"), \"commandFastReadDuration\")") != std::string::npos &&
                    preparation.find("text(routeQuery.column(service::command::persistence::DeviceModelEntity::columnName<\"config\">(), \"p\"), \"commandFastReadInterval\")") != std::string::npos,
