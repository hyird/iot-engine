...
int main() {
    ...
    try {
        ...
        input.acquisitionId = uuidGenerator.next();
        ...
        input.messageId = uuidGenerator.next();
        ...
        input.messageId = uuidGenerator.next();
        input.connectionId = uuidGenerator.next();
        input.causationId = uuidGenerator.next();
        ...
        nextRound.acquisitionId = uuidGenerator.next();
