...
RUVIA_RESPONSE_MODEL(GbMediaPortsDto,
...
RUVIA_RESPONSE_MODEL(GbMediaCapabilitiesDto,
...
RUVIA_RESPONSE_MODEL(GbHealthDto,
    ...
    RUVIA_OPTIONAL_FIELD_NAME("media_capabilities", mediaCapabilities, GbMediaCapabilitiesDto));
...
RUVIA_RESPONSE_MODEL(GbChannelDto,
    RUVIA_OPTIONAL_FIELD(id, ruvia::String),
...
RUVIA_RESPONSE_MODEL(GbRecordDto,
...
RUVIA_RESPONSE_MODEL(GbDeviceDto,
    RUVIA_OPTIONAL_FIELD(id, ruvia::String),
    RUVIA_OPTIONAL_FIELD(name, ruvia::String),
    RUVIA_OPTIONAL_FIELD(manufacturer, ruvia::String),
...
RUVIA_RESPONSE_MODEL(GbStreamDto,
    RUVIA_OPTIONAL_FIELD(id, ruvia::String),
...
RUVIA_RESPONSE_MODEL(GbPreviewStartDto,
...
RUVIA_RESPONSE_MODEL(GbPreviewStopDto,
