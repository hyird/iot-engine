...
RUVIA_DB_ENTITY(AlertRuleEntity, "alert_rule",
    ...
    RUVIA_DB_COLUMN(logic, std::pmr::string,
        ruvia::DbColumnOptions{.dataType = ruvia::DbDataType::kVarchar, .length = 8, .defaultExpression = ruvia::FixedString{"'and'::character varying"}}),
    RUVIA_DB_COLUMN(silence_duration, std::int32_t,
        ruvia::DbColumnOptions{.dataType = ruvia::DbDataType::kInteger, .defaultExpression = ruvia::FixedString{"300"}}),
    RUVIA_DB_COLUMN(recovery_condition, std::pmr::string,
        ruvia::DbColumnOptions{.dataType = ruvia::DbDataType::kVarchar, .length = 32, .defaultExpression = ruvia::FixedString{"'reverse'::character varying"}}),
    RUVIA_DB_COLUMN(recovery_wait_seconds, std::int32_t,
        ruvia::DbColumnOptions{.dataType = ruvia::DbDataType::kInteger, .defaultExpression = ruvia::FixedString{"60"}}),
