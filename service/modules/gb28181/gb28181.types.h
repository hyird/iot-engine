...
RUVIA_MODEL(GbMediaPortsDto, RUVIA_OPTIONAL_FIELD(http, ruvia::Int64), RUVIA_OPTIONAL_FIELD(https, ruvia::Int64), RUVIA_OPTIONAL_FIELD(rtsp, ruvia::Int64), RUVIA_OPTIONAL_FIELD(rtsps, ruvia::Int64), RUVIA_OPTIONAL_FIELD(rtmp, ruvia::Int64), RUVIA_OPTIONAL_FIELD(rtmps, ruvia::Int64), RUVIA_OPTIONAL_FIELD(rtc, ruvia::Int64), RUVIA_OPTIONAL_FIELD(srt, ruvia::Int64));
...
RUVIA_MODEL(GbHealthDto, RUVIA_OPTIONAL_FIELD(status, ruvia::String), RUVIA_OPTIONAL_FIELD(service, ruvia::String), RUVIA_OPTIONAL_FIELD(enabled, ruvia::Bool), RUVIA_OPTIONAL_FIELD(started, ruvia::Bool), RUVIA_OPTIONAL_FIELD(error, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("media_ports", mediaPorts, GbMediaPortsDto), RUVIA_OPTIONAL_FIELD_NAME("media_capabilities", mediaCapabilities, GbMediaCapabilitiesDto));

RUVIA_MODEL(GbSipConfigDto, RUVIA_OPTIONAL_FIELD(domain, ruvia::String), RUVIA_OPTIONAL_FIELD(id, ruvia::String), RUVIA_OPTIONAL_FIELD(host, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("public_ip", publicIp, ruvia::String), RUVIA_OPTIONAL_FIELD(port, ruvia::Int64), RUVIA_OPTIONAL_FIELD(transport, ruvia::String));
...
RUVIA_MODEL(GbDeviceListDto, RUVIA_OPTIONAL_FIELD(items, ruvia::BoxedArray<GbDeviceDto>));

RUVIA_MODEL(GbStreamDto, RUVIA_OPTIONAL_FIELD(id, ruvia::String), RUVIA_OPTIONAL_FIELD(app, ruvia::String), RUVIA_OPTIONAL_FIELD(stream, ruvia::String), RUVIA_OPTIONAL_FIELD(schema, ruvia::String), RUVIA_OPTIONAL_FIELD(online, ruvia::Bool), RUVIA_OPTIONAL_FIELD_NAME("reader_count", readerCount, ruvia::Int64));

RUVIA_MODEL(GbStreamListDto, RUVIA_OPTIONAL_FIELD(items, ruvia::BoxedArray<GbStreamDto>));

RUVIA_MODEL(GbPlayUrlsDto, RUVIA_OPTIONAL_FIELD_NAME("http_flv", httpFlv, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("ws_flv", wsFlv, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("http_ts", httpTs, ruvia::String), RUVIA_OPTIONAL_FIELD(hls, ruvia::String), RUVIA_OPTIONAL_FIELD(webrtc, ruvia::String), RUVIA_OPTIONAL_FIELD(rtsp, ruvia::String), RUVIA_OPTIONAL_FIELD(rtmp, ruvia::String));
...
RUVIA_MODEL(DeviceList, RUVIA_OPTIONAL_FIELD(items, ruvia::Array<Device>));
...
RUVIA_MODEL(StreamList, RUVIA_OPTIONAL_FIELD(items, ruvia::Array<Stream>));
...
#define GB28181_RPC_RESPONSE(name, dataType) \
    RUVIA_MODEL(name, RUVIA_OPTIONAL_FIELD(code, ruvia::Int64), RUVIA_OPTIONAL_FIELD(message, ruvia::String), RUVIA_OPTIONAL_FIELD(data, dataType))
