...
class EdgeConfigService final {
  public:
    static EdgeConfigService& instance() {
        static EdgeConfigService value;
        return value;
    }
...
inline EdgeConfigService& edgeConfigService() { return EdgeConfigService::instance(); }
