...
class LinkController final : public ruvia::Controller<LinkController> {
  public:
    ...
    RUVIA_ROUTES_BEGIN
    RUVIA_GET_SSE("/events", linkEvents, ruvia::QueryModel<LinkListQuery>, ruvia::QueryModel<LinkEventsQuery>);
    RUVIA_GET("/:id/debug/packets", debugPackets, ruvia::PathModel<LinkIdParams>);
    RUVIA_PUT("/:id/debug", setDebug, ruvia::PathModel<LinkIdParams>, ruvia::JsonBody<LinkDebugBody>);
    RUVIA_GET("/", list, ruvia::QueryModel<LinkListQuery>);
    RUVIA_GET("/options", options);
    RUVIA_GET("/enums", enums);
    RUVIA_GET("/public-ip", publicIp);
    RUVIA_GET("/:id", detail, ruvia::PathModel<LinkIdParams>);
    RUVIA_POST("/", create, ruvia::JsonBody<SaveLinkBody>);
    RUVIA_PUT("/:id", update, ruvia::PathModel<LinkIdParams>, ruvia::JsonBody<SaveLinkBody>);
    RUVIA_DELETE("/:id", remove, ruvia::PathModel<LinkIdParams>);
    RUVIA_ROUTES_END
