...
RUVIA_REQUEST_MODEL(DebugAuthenticationBody, RUVIA_REQUIRED_FIELD(token, ruvia::String));

RUVIA_REQUEST_MODEL(EdgeEventsQuery, RUVIA_OPTIONAL_FIELD(nodeId, ruvia::String), RUVIA_OPTIONAL_FIELD(logs, ruvia::Bool, RUVIA_DEFAULT(false)), RUVIA_OPTIONAL_FIELD(vpn, ruvia::Bool, RUVIA_DEFAULT(false)));

RUVIA_REQUEST_MODEL(EdgeListQuery, RUVIA_OPTIONAL_FIELD(page, ruvia::Int64, RUVIA_DEFAULT(1)), RUVIA_OPTIONAL_FIELD_NAME("pageSize", pageSize, ruvia::Int64, RUVIA_DEFAULT(20)), RUVIA_OPTIONAL_FIELD(keyword, ruvia::String), RUVIA_OPTIONAL_FIELD(status, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("groupId", groupId, ruvia::String));

RUVIA_REQUEST_MODEL(EdgeIdParams, RUVIA_OPTIONAL_FIELD(id, ruvia::String));

RUVIA_REQUEST_MODEL(EnrollmentBody, RUVIA_OPTIONAL_FIELD(status, ruvia::String), RUVIA_OPTIONAL_FIELD(name, ruvia::String));

RUVIA_REQUEST_MODEL(NodeNameBody, RUVIA_OPTIONAL_FIELD(name, ruvia::String));

RUVIA_REQUEST_MODEL(NodeGroupBody, RUVIA_OPTIONAL_FIELD_NAME("groupId", groupId, ruvia::String));

RUVIA_REQUEST_MODEL(EdgeGroupBody, RUVIA_OPTIONAL_FIELD(name, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("parentId", parentId, ruvia::String), RUVIA_OPTIONAL_FIELD(status, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("sortOrder", sortOrder, ruvia::Int64, RUVIA_DEFAULT(0)), RUVIA_OPTIONAL_FIELD(remark, ruvia::String));

RUVIA_REQUEST_MODEL(NetworkInterfaceBody, RUVIA_OPTIONAL_FIELD(operation, ruvia::String), RUVIA_OPTIONAL_FIELD(name, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("previousName", previousName, ruvia::String), RUVIA_OPTIONAL_FIELD(mode, ruvia::String), RUVIA_OPTIONAL_FIELD(device, ruvia::String), RUVIA_OPTIONAL_FIELD(bridge, ruvia::Bool, RUVIA_DEFAULT(false)), RUVIA_OPTIONAL_FIELD_NAME("bridgePorts", bridgePorts, ruvia::Array<ruvia::String>), RUVIA_OPTIONAL_FIELD(ip, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("prefixLength", prefixLength, ruvia::Int64, RUVIA_DEFAULT(0)), RUVIA_OPTIONAL_FIELD(gateway, ruvia::String));

RUVIA_REQUEST_MODEL(NetworkBody, RUVIA_OPTIONAL_FIELD(interfaces, ruvia::Array<NetworkInterfaceBody>), RUVIA_OPTIONAL_FIELD_NAME("rollbackTimeoutSec", rollbackTimeoutSec, ruvia::Int64, RUVIA_DEFAULT(60)));

RUVIA_REQUEST_MODEL(FirmwareUploadBody, RUVIA_OPTIONAL_FIELD_NAME("fileName", fileName, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("sizeBytes", sizeBytes, ruvia::Int64), RUVIA_OPTIONAL_FIELD_NAME("keepSettings", keepSettings, ruvia::Bool, RUVIA_DEFAULT(true)));

RUVIA_REQUEST_MODEL(FirmwareDownloadQuery, RUVIA_OPTIONAL_FIELD(token, ruvia::String));

RUVIA_REQUEST_MODEL(LogsQuery, RUVIA_OPTIONAL_FIELD(limit, ruvia::Int64, RUVIA_DEFAULT(48)), RUVIA_OPTIONAL_FIELD(level, ruvia::String), RUVIA_OPTIONAL_FIELD(source, ruvia::String));

RUVIA_REQUEST_MODEL(LogLevelBody, RUVIA_OPTIONAL_FIELD(level, ruvia::String));
...
RUVIA_REQUEST_MODEL(SerialDebugOpenRequest, RUVIA_OPTIONAL_FIELD(path, ruvia::String));

RUVIA_REQUEST_MODEL(SerialDebugCommandRequest, RUVIA_OPTIONAL_FIELD(action, ruvia::String), RUVIA_OPTIONAL_FIELD(requestId, ruvia::Int64), RUVIA_OPTIONAL_FIELD(baudRate, ruvia::Int64), RUVIA_OPTIONAL_FIELD(dataBits, ruvia::Int64), RUVIA_OPTIONAL_FIELD(stopBits, ruvia::Int64), RUVIA_OPTIONAL_FIELD(parity, ruvia::String), RUVIA_OPTIONAL_FIELD(rs485, ruvia::Bool), RUVIA_OPTIONAL_FIELD(hex, ruvia::String));

struct NodeSerialOpenInput final {
    std::string id;
    SerialDebugOpenRequest configuration;
};

RUVIA_REQUEST_MODEL(TerminalOpenInput, RUVIA_OPTIONAL_FIELD(id, ruvia::String), RUVIA_OPTIONAL_FIELD(columns, ruvia::Int64), RUVIA_OPTIONAL_FIELD(rows, ruvia::Int64));
RUVIA_REQUEST_MODEL(TerminalSessionInput, RUVIA_OPTIONAL_FIELD(id, ruvia::String), RUVIA_OPTIONAL_FIELD(sessionId, ruvia::String));
RUVIA_REQUEST_MODEL(TerminalResizeInput, RUVIA_OPTIONAL_FIELD(id, ruvia::String), RUVIA_OPTIONAL_FIELD(sessionId, ruvia::String), RUVIA_OPTIONAL_FIELD(columns, ruvia::Int64), RUVIA_OPTIONAL_FIELD(rows, ruvia::Int64));
RUVIA_REQUEST_MODEL(TerminalWriteInput, RUVIA_OPTIONAL_FIELD(id, ruvia::String), RUVIA_OPTIONAL_FIELD(sessionId, ruvia::String), RUVIA_OPTIONAL_FIELD(content, ruvia::String));
RUVIA_REQUEST_MODEL(TerminalAckInput, RUVIA_OPTIONAL_FIELD(id, ruvia::String), RUVIA_OPTIONAL_FIELD(sessionId, ruvia::String), RUVIA_OPTIONAL_FIELD(sequence, ruvia::Int64));

RUVIA_REQUEST_MODEL(NodeSerialSessionInput, RUVIA_OPTIONAL_FIELD(id, ruvia::String), RUVIA_OPTIONAL_FIELD(sessionId, ruvia::String));

struct NodeSerialCommandInput final {
    std::string id;
    std::string sessionId;
    SerialDebugCommandRequest command;
