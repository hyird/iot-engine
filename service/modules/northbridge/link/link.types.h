...
RUVIA_REQUEST_MODEL(LinkIdParams, RUVIA_FIELD(id, ruvia::String));

RUVIA_RESPONSE_MODEL(LinkTargetDto, RUVIA_FIELD(id, ruvia::String),
                     RUVIA_FIELD(name, ruvia::String), RUVIA_FIELD(ip, ruvia::String),
                     RUVIA_FIELD(port, ruvia::Int64), RUVIA_FIELD(status, ruvia::String),
                     RUVIA_FIELD_NAME("conn_status", connStatus, ruvia::String),
                     RUVIA_FIELD_NAME("state_reason", stateReason, ruvia::String),
                     RUVIA_FIELD_NAME("error_msg", errorMessage, ruvia::String),
                     RUVIA_FIELD_NAME("last_activity_at_ms", lastActivityAtMs, ruvia::Int64));

RUVIA_RESPONSE_MODEL(LinkItemDto, RUVIA_FIELD(id, ruvia::String), RUVIA_FIELD(name, ruvia::String),
                     RUVIA_FIELD(mode, ruvia::String), RUVIA_FIELD(protocol, ruvia::String),
                     RUVIA_FIELD(ip, ruvia::String), RUVIA_FIELD(port, ruvia::Int64),
                     ...
                     RUVIA_FIELD_NAME("state_reason", stateReason, ruvia::String),
                     RUVIA_FIELD(clients, ruvia::List<ruvia::String>),
                     RUVIA_FIELD_NAME("error_msg", errorMessage, ruvia::String),
...
RUVIA_RESPONSE_MODEL(LinkOptionDto, RUVIA_FIELD(id, ruvia::String),
                     RUVIA_FIELD(name, ruvia::String), RUVIA_FIELD(mode, ruvia::String),
...
RUVIA_RESPONSE_MODEL(PublicIpDto, RUVIA_FIELD(ip, ruvia::String));
RUVIA_RESPONSE_MODEL(PublicIpResponse, RUVIA_FIELD(code, ruvia::Int64),
                     RUVIA_FIELD(message, ruvia::String), RUVIA_FIELD(data, PublicIpDto));
