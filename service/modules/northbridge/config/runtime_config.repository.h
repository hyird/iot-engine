...
namespace service::northbridge::config::repository {

using service::southbridge::DeviceDefinition;
using service::southbridge::ElementDefinition;
using service::southbridge::LinkDefinition;
using service::southbridge::LinkTargetDefinition;
using service::southbridge::RuntimeSnapshot;
