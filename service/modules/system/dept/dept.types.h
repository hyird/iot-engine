...
RUVIA_REQUEST_MODEL(CreateDeptBody, RUVIA_FIELD(name, ruvia::String),
                    ...
                    RUVIA_FIELD_NAME("leader_id", leaderId, ruvia::String),
...
RUVIA_REQUEST_MODEL(DeptIdParams, RUVIA_FIELD(id, ruvia::String));

RUVIA_RESPONSE_MODEL(DeptOptionDto, RUVIA_FIELD(id, ruvia::String),
                     RUVIA_FIELD(name, ruvia::String),
                     RUVIA_FIELD_NAME("parent_id", parentId, ruvia::String));

RUVIA_RESPONSE_MODEL(DeptItemDto, RUVIA_FIELD(id, ruvia::String), RUVIA_FIELD(name, ruvia::String),
