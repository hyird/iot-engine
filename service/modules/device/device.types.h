...
RUVIA_REQUEST_MODEL(DeviceEventsQuery, RUVIA_OPTIONAL_FIELD_NAME("debugDeviceId", debugDeviceId, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("commandIds", commandIds, ruvia::String));
RUVIA_REQUEST_MODEL(DeviceCommandStatusesQuery, RUVIA_REQUIRED_FIELD(ids, ruvia::String));
...
RUVIA_REQUEST_MODEL(DeviceIdParams, RUVIA_OPTIONAL_FIELD(id, ruvia::String));
...
RUVIA_REQUEST_MODEL(ReplaceDeviceSharesBody, RUVIA_OPTIONAL_FIELD(shares, ruvia::Array<DeviceShareBodyItem>));
...
RUVIA_REQUEST_MODEL(SaveDeviceBody, RUVIA_OPTIONAL_FIELD(name, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("device_code", deviceCode, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("link_id", linkId, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("target_id", targetId, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("protocol_config_id", protocolConfigId, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("group_id", groupId, ruvia::String), RUVIA_OPTIONAL_FIELD(status, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("online_timeout", onlineTimeout, ruvia::Int64), RUVIA_OPTIONAL_FIELD_NAME("remote_control", remoteControl, ruvia::Bool), RUVIA_OPTIONAL_FIELD_NAME("modbus_mode", modbusMode, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("slave_id", slaveId, ruvia::Int64), RUVIA_OPTIONAL_FIELD(timezone, ruvia::String), RUVIA_OPTIONAL_FIELD(heartbeat, DevicePacketBody), RUVIA_OPTIONAL_FIELD(registration, DevicePacketBody), RUVIA_OPTIONAL_FIELD(remark, ruvia::String));
...
RUVIA_REQUEST_MODEL(DeviceCommandBody, RUVIA_OPTIONAL_FIELD_NAME("idempotency_key", idempotencyKey, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("deviceId", deviceId, ruvia::String), RUVIA_OPTIONAL_FIELD(elements, ruvia::Array<DeviceCommandElementBody>));
...
RUVIA_REQUEST_MODEL(SaveDeviceGroupBody, RUVIA_OPTIONAL_FIELD(name, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("parent_id", parentId, ruvia::String), RUVIA_OPTIONAL_FIELD(status, ruvia::String), RUVIA_OPTIONAL_FIELD_NAME("sort_order", sortOrder, ruvia::Int64), RUVIA_OPTIONAL_FIELD(remark, ruvia::String));
...
RUVIA_REQUEST_MODEL(DeviceHistoryQuery, RUVIA_REQUIRED_FIELD(startTime, ruvia::String), RUVIA_REQUIRED_FIELD(endTime, ruvia::String), RUVIA_OPTIONAL_FIELD(page, ruvia::Int64, RUVIA_DEFAULT(1)), RUVIA_OPTIONAL_FIELD(pageSize, ruvia::Int64, RUVIA_DEFAULT(20)));
